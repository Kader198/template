...
const Navs: NextPage<Props> = ({}) => {
  return (
    <div
      id="docs-sidebar"
      className="   fixed top-16 left-0 bottom-0 z-[60] w-64 bg-white border-r border-gray-200 pt-7 pb-10 sm:hidden lg:block lg:translate-x-0 lg:right-auto lg:bottom-0 dark:scrollbar-y dark:bg-gray-800 dark:border-gray-700"
    >
      <nav
